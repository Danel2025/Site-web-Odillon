        ...
        const emailHtml = `
          ...
          <html>
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background: linear-gradient(135deg, #39837a 0%, #0A1F2C 100%); padding: 30px; text-align: center; border-radius: 8px 8px 0 0;">
                <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Nouveau message de contact</h1>
              </div>
              
              <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb; border-top: none;">
                <div style="background: white; padding: 20px; border-radius: 6px; margin-bottom: 20px;">
                  <h2 style="color: #39837a; margin-top: 0; font-size: 18px; border-bottom: 2px solid #39837a; padding-bottom: 10px;">
                    Informations de l'expéditeur
                  </h2>
                  <p style="margin: 10px 0;"><strong>Nom :</strong> ${safeName}</p>
                  <p style="margin: 10px 0;"><strong>Email :</strong> <a href="mailto:${safeEmail}" style="color: #39837a;">${safeEmail}</a></p>
                  ${safePhone ? `<p style="margin: 10px 0;"><strong>Téléphone :</strong> <a href="tel:${safePhone}" style="color: #39837a;">${safePhone}</a></p>` : ''}
